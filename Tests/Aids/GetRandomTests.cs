...
namespace MaskShop.Tests.Aids
{
    ...
    public class GetRandomTests : BaseTests
    {
        ...
        [TestInitialize]
        public void TestInitialize() => Type = typeof(GetRandom);
        ...
        [TestMethod]
        public void ColorTest() => doTests(GetRandom.Color);
        ...
        {
            var e = GetRandom.Enum<PartyType>();
            Assert.IsInstanceOfType(e, typeof(PartyType));

            while (true)
                if (GetRandom.Enum<PartyType>() != e)
                    return;
        }
        ...
        public void ValueTest()
        {
            ...
            test(typeof(PartyType?), typeof(PartyType));
        ...
        public void ObjectTest()
        {
            ...
            var o = GetRandom.Object(typeof(ProductData)) as ProductData;
            Assert.IsNotNull(o);
            Assert.IsFalse(string.IsNullOrWhiteSpace(o.Id));
            Assert.IsFalse(string.IsNullOrWhiteSpace(o.PriceComponentId));
