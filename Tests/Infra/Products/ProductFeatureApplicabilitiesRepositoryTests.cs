...
{
    [TestClass]
    public class ProductFeatureApplicabilitiesRepositoryTests : ShopDbContextTests<ProductFeatureApplicabilitiesRepository, ProductFeatureApplicability, ProductFeatureApplicabilityData>
    {
