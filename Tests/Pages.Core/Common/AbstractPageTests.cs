...
//        internal abstract class testClass : UnifiedPage<ViewPage<ProductsPage<>, IProductsRepository, Product, ProductView, ProductData>>
//        {

//            internal string subTitle { get; set; } = string.Empty;

//            protected internal testClass(IProductsRepository r) : base(r, ProductPagesNames.Products) { }
